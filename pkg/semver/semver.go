...
This file is taken from https://github.com/blang/semver/blob/master/semver.go
...
func (v Version) Compare(o Version) int {
	...
	if len(v.Pre) == 0 && len(o.Pre) == 0 { //nolint
		return 0
	...
	for ; i < len(v.Pre) && i < len(o.Pre); i++ {
		if comp := v.Pre[i].Compare(o.Pre[i]); comp == 0 { //nolint
			continue
		} else if comp == 1 {
			return 1
		} else {
	...
	if i == len(v.Pre) && i == len(o.Pre) { //nolint
		return 0
...
func NewPRVersion(s string) (PRVersion, error) {
	...
	v := PRVersion{}
	if containsOnly(s, numbers) { //nolint
...
func (v PRVersion) Compare(o PRVersion) int {
	if v.IsNum && !o.IsNum { //nolint
		return -1
	} else if !v.IsNum && o.IsNum {
		return 1
	} else if v.IsNum && o.IsNum {
		if v.VersionNum == o.VersionNum { //nolint
			return 0
